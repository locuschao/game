...
<body>
	<div class='panel wst-panel-full'>
		<div class="col-xs-12 wstmall-login-tips">
			<p style='font-size: 16px;'>您好，<?php echo session('WST_STAFF.staffName');?>，欢迎使用
				O2O在线商城后台管理。 您上次登录的时间是 <?php echo session('WST_STAFF.lastTime');?> ，IP 是
				<?php echo session('WST_STAFF.lastIP');?></p>
		</div>
		<div class='row' style='padding-left: 10px; margin-right: 10px;'>
			...
			<!--      <div class="col-md-3">
	           ...
	           <div class="box-header">
	             ...
	             <div style='padding-left:5px;'>QQ：354575573</div>
	           </div>
	        </div> -->
		</div>
	</div>
