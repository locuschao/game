...
//       $this->ip=get_client_ip();
	...
	/* 	echo strtotime('2016-4-29 16:00:00');
		...
		$this->uinfo=M('users')->where(array('userId'=>session('oto_userId')))->field('userPhone,userPhoto,userName')->find();
		//p($res);return;
		$this->display();
	}
...
function arrayPidProcess($data,$res=array(),$pid='0'){
	...
	public  function goodsDetail(){
	    ...
	    $filed="g.goodsSn,g.marketPrice,g.goodsName,g.marketPrice,g.shopPrice,g.goodsStock,g.goodsUnit,g.goodsDesc,g.goodsId,g.goodsThums,g.goodsImg";
	    $map['g.goodsFlag']=1;
	    $map['g.goodsId']=$id;
	    $map['g.goodsStatus']=1;
