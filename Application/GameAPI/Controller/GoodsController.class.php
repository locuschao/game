    ...
    public function index()
    {
         ...
         */
         ...
         foreach($dai_versions_info as $k=>$row){
            $dc_price_assoc[$row['versionsId']]=$row['min_zhekou'] * 10;
         }    
        ...
        $sales = D('Game/Goods')->getShopNum($goodsInfo['shopId']);
        ...
        $downLoadUrl=M('game')->where(array(
            'id' => $goodsInfo['gameId']
        ...
        $arr['sales'] = $sales;
        $arr['downLoadUrl'] = $downLoadUrl;
        $arr['gameName'] = $gameName;
        $arr['goodsAttr'] = $goodsAttr;
        //peng
        $arr['dc_price_assoc'] = $dc_price_assoc;
