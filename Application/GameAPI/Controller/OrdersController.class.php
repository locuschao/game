...
class OrdersController extends BaseController
{
    ...
    public function buy()
    {
        ...
        if ($attrInfo) {
             ...
             */
            $reduceMoney = A('Game/Voucher')->checkVoucher($attrInfo,$goodsInfo,$attrInfo['attrPrice']*$num);
            if($reduceMoney === false) {
                ...
                $arr['reduce_money'] = $reduceMoney;
            }
            
            $arr['totalMoney']=sprintf('%0.2f', $attrInfo['attrPrice']*$num-$reduceMoney);
        } else {
    ...
    public function daiChongBuy()
    {
        ...
        $goodsInfo = M('goods as g')->where(array(
            ...
            ->field('g.goodsThums,g.goodsId,g.goodsName,g.goodsStock,g.marketPrice,g.shopPrice,g.scopeId,g.gameId,goodsType')
            ->find();
    ...
    public function checkPayInfo()
    {
        ...
        if(($currentH>=$shopInfo['serviceStartTime']&&$currentH<=$shopInfo['serviceEndTime']) || $shopInfo === true){
    ...
    public function orders($page = 0, $limit = 20, $userId = 0)
    {
        ...
        $map['o.orderStatus'] = array(
            'in',
            "-2,0,1,2,3,4,-5,-6,-3,-4,-9,-7"
        );
        $field = "o.signTime,o.orderStatus,o.orderId,o.shopId,o.needPay,o.roleName,o.profession,o.paytime,o.createTime,g.goodsName,g.goodsNums,g.goodsPrice,g.goodsAttrName,g.goodsId,g.goodsThums,g.vid,g.gid,o.orderType,v.vName,ga.gameName,o.cancelTime";
        $waitPay = M('orders')->join('as o left join oto_order_goods  as g on o.orderId=g.orderId')
            ->join('left join oto_versions as v on g.vid=v.id')
            ->join('left join  oto_game as ga on ga.id=g.gid')
            ->where($map)
        ...
        foreach ($waitPay as $k => $v) {
            ...
            $waitPay[$k]['type'] = $type;
            //peng
            $waitPay[$k]['cancelTime'] = date("Y-m-d H:i:s",$v['cancelTime']);
