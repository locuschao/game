...
class IndexController extends BaseController
{
    ...
    public function getUserInfo()
    {
        $userId = I('userId');
        $userId = authCode($userId);
        $field = "userPhone,userPhoto,userMoney,isAgent,rank";
