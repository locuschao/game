 ...
 * 商品控制器
 */
class NoticegameController extends BaseController
{
    ...
    public function toEdit()
    {
        ...
        $this->view->display('/noticegame/edit');
    }
    ...
    public function noticeExp()
    {
        ...
        $xlsModel = M('notice');
        $sql = " select id,title,createTime from __PREFIX__game_notice where  UNIX_TIMESTAMP(createTime) >= $start and UNIX_TIMESTAMP(createTime) <= $end order by id desc ";
