 ...
 * 广告服务类
 */
class GameAdsModel extends BaseModel
{
    ...
    public function queryByPage()
    {
        ...
        $sql = "select a.*,a1.areaName areaName1,a2.areaName areaName2
	 	        from __PREFIX__game_ads a left join __PREFIX__areas a1 on a.areaId1=a1.areaId 
    ...
    {
        $m = M('game_ads');
        $sql = "select * from __PREFIX__game_ads order by adId desc";
        return $m->find($sql);
    }
