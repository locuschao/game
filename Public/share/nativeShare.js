...
var nativeShare = function (elementNode, config) {
    ...
    this.share = function (to_app) {
        ...
        if (isucBrowser) {
            ...
            if (typeof(ucweb) != "undefined") {
                ucweb.startRequest("shell.page_share", [title, config.descreption, url, to_app, "", "@" + from, ""])
            } else {
                if (typeof(ucbrowser) != "undefined") {
                    //ucbrowser.web_share(title, title, url, to_app, "", "@" + from, '')
                    ucbrowser.web_share(title, config.descreption, url, to_app, "", "", '')
                } else {
                }
            }
        } else {
    ...
    this.html = function() {
        ...
        var html = '';
        var append_html = '<div class="top-banner"><img src="/Tpl/Game/css/newRegister/hp_img1.png"/></div>';
        
        html = append_html + '<div class="label">分享到</div>'+
